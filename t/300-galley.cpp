...
main()
    ...
    { /* 1..4 */
        ...
        std::shared_ptr<StampTwoChars> stamp;
    ...
    {  /* 5 .. 9*/
        ...
        std::shared_ptr<StampTwoCharsList> stamp_charlist;
    ...
    { /* 10..13 */
        ...
        std::shared_ptr<StampArithm<unsigned short int>> stamp;
    ...
    { /* 14 */
        ...
        std::shared_ptr<StampArithm<signed int>> stamp;
    ...
    {  /* 15 .. 19*/
        ...
        std::shared_ptr<StampSeveralChars> stamp;
        GalleyVectorStr galley(stamp);
